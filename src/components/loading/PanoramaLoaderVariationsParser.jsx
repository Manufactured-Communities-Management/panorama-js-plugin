...
import {getStyleIndexByStyleId, getLocationIndexByLocationId, getSelectedVariationIndexesBySku, getTexturePathsToRender} from '../utils/PanoramaVariationParsingUtils.jsx';
...
export const PanoramaLoaderVariationsParser = ({src = undefined, styleIndex:givenStyleIndex = undefined, locationIndex:givenLocationIndex = undefined, ...props}) =>
{
	...
	const styleIndex = LeRed.useMemo(() => styleId ? getStyleIndexByStyleId(locations, styleId) : 0, [styleId]);
