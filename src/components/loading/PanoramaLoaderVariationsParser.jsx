...
export const PanoramaLoaderVariationsParser = ({src = undefined, styleIndex:givenStyleIndex = undefined, locationIndex:givenLocationIndex = undefined, ...props}) =>
{
	...
	const styleIndex = LeRed.useMemo(() => styleId ? LeUtils.findIndex(styles, style => style?.styleId === styleId) : 0, [styleId]);
	...
	const locationIndex = LeRed.useMemo(() => locationId ? LeUtils.findIndex(locations, location => location?.locationId === locationId) : 0, [locationId]);
